...
function Screen({ frame, panel, children, ...props }) {
  const { nodes, materials } = useGLTF('/fonts/computers_1-transformed.glb')
  return (
    <group {...props}>
...
function ScreenText({ invert, x = 0, y = 1.2, ...props }) {
  ...
  return (
    <Screen {...props}>
      ...
      <Text font="/fonts/Inter-Medium.woff" position={[x, y, 0]} ref={textRef} fontSize={4} letterSpacing={-0.1} color={!invert ? 'black' : '#35c19f'}>
        ReversedBullet.
      </Text>
    </Screen>
  )
